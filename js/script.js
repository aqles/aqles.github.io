...
//List command
	const commands = {
	  help: () => 'Available: help, about, contact, clear, clearhistory, date, time, dottrick, weather, uptime, projects, skills, joke, quote, ascii, echo, calc, random, ip, techstack, experience and Ask for Asking',
